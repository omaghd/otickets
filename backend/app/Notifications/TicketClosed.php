...
class TicketClosed extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject("[REF #$reference] Ticket Closed | $appName")
            ->greeting("Hello $notifiable->name,")
            ->lines([
                "The ticket (#$reference) has been marked as closed by the $this->markedBy.",
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            'reference' => $reference,
            'message'   => "The ticket (#$reference) has been marked as closed by the $this->markedBy",
        ];
    }
}
